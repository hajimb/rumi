<?php
	...
	$total_line ='';
	$total_count = 0;	
	$handle = fopen("../lead_appointment.csv", "r");
	if ($handle) {
...
<body>
<div class="top">
    <div class="leftpanel"><span class="lnk" style="color:#fff;font-weight:bold;">Appointments Lead  - </span> <a href="../lead_appointment.csv">Download Leads</a></div> 
    <div class="middlepanel"><a href="quote.php">Get Quote Lead</a></div>
