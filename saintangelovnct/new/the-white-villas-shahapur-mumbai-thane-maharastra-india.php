           ...
           var ID = $(".message_box:last").attr("id");
			...
			$.get(url, function(data) {
				...
				if (data != "") {
					...
					//$(".message_box:last").append($(data).hide().fadeIn(2000));
					//data.hide(); // instant hide the wall_post
					//data.fadeIn(3000); // let is fadein slow
				}
...
/*		var st = $(window).scrollTop();
		...
		if(st>500){
			alert('ScrollTop:'+st+'     Doc Height:'+dh+'     Window Height:'+wh+'      Minus:'+ (dh - wh) );
		}
*/
