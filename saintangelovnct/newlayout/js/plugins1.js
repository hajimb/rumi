...
(function(e) {
    ...
    var i, s = e("<img />").addClass("vegas-background"),
        ...
        h = {
            init: function(o) {
                ...
                var g = s.clone();
				//console.log('init:'+JSON.stringify(g));
				var m = $.parseJSON(JSON.stringify(o));
				//console.log('init id :'+m.id);
				var hh = "btn"+m.id;
				//console.log('init div :'+hh);
				$(".bttn").removeClass("cred").addClass("cwhite");
				$("#"+hh).removeClass("cwhite").addClass("cred");
    ...
    e.vegas = function(t) {
		//console.log('vegas:'+JSON.stringify(t));
...
(function(e) {
    e.fn.cemara = function(t) {
        ...
        n.options = e.extend(r, t);
        n.init = function() {
            e(".nav-wrap", n).hover(function() {
                e(this).addClass("hover");
                e(".menu", n).stop().animate({
                    dist: 300
                }, {
                    step: function(t, n) {
                        e(this).css("clip", "rect(0px " + t + "px auto 0px)")
                    }
                })
            }, function() {
            ...
            e(".menu a", n).bind("click", function(t) {
                t.preventDefault();
                var r = e(window).width();
                var i = e(e(this).attr("href"), n);
                if (i.size()) {
                    n.addClass("popup");
                    if (n.currentPage || n.activePage) {
                        (n.currentPage ? n.currentPage : n.activePage).stop().animate({
                            dist: 0
                        }, {
                            duration: 2e3,
                            step: function(t, n) {
            ...
            e(".close-this").bind("click", function(t) {
                t.preventDefault();
                if (n.currentPage || n.activePage) {
                    (n.currentPage ? n.currentPage : n.activePage).stop().animate({
                        dist: 0
            ...
            e("#countdown", n).dsCountDown(n.options);
            e(":input[placeholder]", n).placeholder();
            e(".popup-trigger", n).cemaraClipBottom();
            e(".popup-trigger1", n).cemaraClipBottom();
            e("form", n).submit(function(t) {
                ...
                var r = n.attr("action") + "?ajax=1";
                var i = n.serialize();
                n.addClass("processing");
                e.ajax({
                    type: "POST",
                    url: r,
                    dataType: "json",
                    ...
                    success: function(e) {
                        if (e.error) {
                            n.find(".message").html(e.message)
                        } else if (e.success) {
                            n.find(".message").html(e.message);
                            n.find('input[type="text"]').val("");
                            n.find("textarea").val("")
                        }
                        n.removeClass("processing")
                    }
                })
            });
            e(".btn-trigger", n).bind("click", function(e) {
                e.preventDefault()
            });
            e("#preloader", n).fadeOut("slow", function() {
                n.removeClass("still-loading")
            });
            if (n.options.videoId) {} else {
                var t = e("#background img", n);
                if (t.size() == 1) {
                    var r = t.attr("src");
                    e.vegas({
                        src: r,
        ...
        n.openCurrentPage = function(t) {
            var r = e(window).width();
            n.currentPage.delay(t).animate({
                dist: r
            }, {
                duration: 1500,
                step: function(t, n) {
                ...
                complete: function() {
                    n.activePage = n.currentPage;
                    n.currentPage = null;
                    e(this).css("clip", "rect(0px auto auto 0px)")
                }
            })
        };
        n.preloading = function() {
            n.addClass("still-loading");
            var t = e('<div id="preloader"><div class="loading"><div class="label">loading...</div><div class="loading-indicators"></div></div></div>');
            n.prepend(t);
            t.numberBg = e("#background img", n).size();
            if (t.numberBg) {
                e("#background img", n).each(function(r) {
                    e(".loading-indicators", t).append('<span class="indicator-' + r + '"></span>');
                    var i = e(this);
                    i.itemIndex = r;
                    var s = new Image;
                    s.onload = function() {
                        e(".indicator-" + i.itemIndex, t).addClass("done");
                        if (e(".done", t).size() >= t.numberBg) {
                            setTimeout(function() {
                                n.init()
                            }, 500)
                        }
                    };
                    s.src = e(this).attr("src")
                })
            } else {
                n.init()
            }
    ...
    e.fn.cemaraClipBottom = function() {
        var t = this;
        t.dist = t.attr("href");
        ...
        t.bind("click", function(n) {
            n.preventDefault();
            e(t.dist).stop().animate({
                dist: e(t.dist).height()
            }, {
                duration: 1e3,
                step: function(t, n) {
                    e(this).css("clip", "rect(0px auto " + t + "px 0px)")
                },
                complete: function() {
                    e(this).css("clip", "rect(0px auto auto 0px)")
                }
        ...
        e(t.dist + " .close-popup").bind("click", function(n) {
            n.preventDefault();
            e(t.dist).stop().animate({
                dist: 0
            }, {
    ...
    e(window).load(function() {
        e(".page-container").mCustomScrollbar({
            theme: "dark"
        })
    })
})(jQuery);
jQuery(document).ready(function(e) {
    var t = {
        startDate: new Date,
        endDate: new Date("June 30, 2016 11:13:00")
    };
    e("#container").cemara(t)
});