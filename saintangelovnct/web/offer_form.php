...
?>
<aside id="text-3" class="widget widget-text" style="border:1px solid #FFF;padding:0 10px ;margin:10px 0;background-color:#fff;border:1px solid #cecece; border-radius:10px;">
