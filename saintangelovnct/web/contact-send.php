...
$feedbackbody  = "<html><meta http-equiv=\"content-type\" content=\"text/html;charset=utf-8\" />".
				...
				"<p>Thank you for your interest expressed in our project <strong>%projects%</strong>. We will get in touch with you soon!<br>\n".
...
function SendEnquiry(){
	...
	if($captchacode != "OK"){
		...
		//$sendto   = "agnelorajesh@saintangelosvnct.com,geethanagu@saintangelosvnct.com,sales@saintangelosvnct.com";
		...
		$msgbody=str_replace("%projects%",$projects, $msgbody);
		date_default_timezone_set('Asia/Kolkata');
		$cur_date = date("d-m-Y h:i:s A");
	//	$cur_date = date("d-m-Y H:i:s");
		$strlead = $cur_date.','.$name.",".$email.",".$mobile.",".$country.",".$city.",".$projects;
...
function SendOffer(){
	...
	if($captchacode != "OK"){
		...
		$name     	= str_replace(',',' ',$_REQUEST['name']);
		$mobile   	= str_replace(',',' ',$_REQUEST['mobile']);
		$venue   	= str_replace(',',' ',$_REQUEST['venue']);
		$project   	= str_replace(',',' ',$_REQUEST['project']);
		$country	= str_replace(',',' ',$_REQUEST['country']);
